...
def ellipsoidalDistance(a, b):
    """
    Calculate the 'as the crow flies' distance between two locations along an ellipsoid
  using    the Inverse Vincenty method, via the PyProj library.
    """
...
# test the number of entries in your Index against the number of nodes in your Graph:
